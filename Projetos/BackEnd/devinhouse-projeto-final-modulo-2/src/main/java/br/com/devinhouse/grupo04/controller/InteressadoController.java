...
public class InteressadoController {
	...
	@Operation(summary = "Cria um novo interessado")
	...
	@Operation(summary = "Listar todos os interessados")
	...
	@Operation(summary = "Buscar interessado por ID")
	...
	@Operation(summary = "Atualiza um interessado por ID")
	...
	@Operation(summary = "Deleta um Interessado por ID")
